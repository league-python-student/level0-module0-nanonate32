...
if __name__ == '__main__':
    ...
    liquid = simpledialog.askstring(title = None , prompt = 'Enter a type of liquid')
    ...
    messagebox.showinfo(title = None, message =  "Piranhas are more " + adjective +  " during the day, so cross the river at\n"
